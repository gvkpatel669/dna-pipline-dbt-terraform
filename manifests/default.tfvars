...
dbt_projects = [
  {
    name                      = "GSAP"
    github_repo_name          = "dna-gsap-dbt"
    github_repo_branch        = "main"
    snowflake_connection_name = "Snowflake POC - Playground GSAP"
    dbt_target_name           = "dev"
    dbt_schema_prefix         = "GSAP"
  },
  {
    name                      = "DIMS"
    github_repo_name          = "dna-dims-dbt"
    github_repo_branch        = "main"
    snowflake_connection_name = "Snowflake POC - Playground DIMS"
    dbt_target_name           = "dev"
    dbt_schema_prefix         = "DIMS"
  },
  {
    name                      = "RISKNET"
    github_repo_name          = "dna-risknet-dbt"
    github_repo_branch        = "main"
    snowflake_connection_name = "Snowflake POC - Playground Risknet"
    dbt_target_name           = "dev"
    dbt_schema_prefix         = "RISKNET"
  },
  {
    name                      = "GMAS"
    github_repo_name          = "dna-gmas-dbt"
    github_repo_branch        = "main"
    snowflake_connection_name = "Snowflake POC - Playground GMAS"
    dbt_target_name           = "dev"
    dbt_schema_prefix         = "GMAS"
  },
]
